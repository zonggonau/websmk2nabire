	...
	<div class="container text-center">
		...
		<div class="row pt-3">
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mb-4">
				...
				<h5 class="mt-2">Teknik Konstruksi dan Perumahan</h5>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mb-4">
				<img class="" src="<?= base_url('img/jurusan/calculator.svg') ?>" alt="">
				<h5 class="mt-2">Teknik Instalasi Tenaga Listrik</h5>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mb-4">
				<img class="" src="<?= base_url('img/jurusan/calculator.svg') ?>" alt="">
				<h5 class="mt-2">Teknik Audio Video</h5>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mb-4">
				<img class="" src="<?= base_url('img/jurusan/calculator.svg') ?>" alt="">
				<h5 class="mt-2">Teknik Sepeda Motor</h5>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mb-4">
				<img class="" src="<?= base_url('img/jurusan/work.svg') ?>" alt="">
				<h5 class="mt-2">Teknik Komputer dan Jaringan</h5>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 mb-4">
				<img class="" src="<?= base_url('img/jurusan/marketing.svg') ?>" alt="">
				<h5 class="mt-2">Teknik Kendaraan Ringan Otomotif</h5>
			</div>
		</div>
	</div>
</div>
